...
- **Objective function**: maximize the penalized log likelihood with some $\lambda \geq 0$:
...
- Smoothed Bootstrap
  + We define lasso logistic regression models with different $\lambda$s are considered different models. All models are wrong
...
- **Inference**: the nonparametric delta-method estimate of se:
\[
...
### Significant Proteins Selection by Smooth Bootstrap Estimation
