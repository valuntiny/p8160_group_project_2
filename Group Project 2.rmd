...
ans2 <- gradient(dat, logisticstuff, rep(3,31), maxiter = 500)
# we choose start point at rep(3,31), but still it doesn't converge
```
...
ans3 <- coordinate(dat, rep(1, 31), maxiter = 500)
